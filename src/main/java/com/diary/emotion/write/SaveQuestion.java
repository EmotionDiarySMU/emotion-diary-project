...
import com.diary.emotion.view.ModifyPanel;

import javax.swing.*;

public class SaveQuestion {
    /**
     * WriteDiaryGUI용 창 닫기 처리
     */
    ...
    /**
     * ModifyPanel용 창 닫기 처리 (오버로드)
     */
    public static Integer handleWindowClosing(JFrame frame, ModifyPanel panel, int exitProgram) {
